...
if pilihan_uplm == "UPLM 1":
    ...
    def kunjungan_perpus_umum():
        ...
        perhitungan_kb_u = kunj_kab / (populasi_kun if populasi_kun != 0 else 1)  # Menangani pembagian oleh nol
        ...
        perhitungan_kc_u = kunj_kec / (populasi_kun if populasi_kun != 0 else 1)
